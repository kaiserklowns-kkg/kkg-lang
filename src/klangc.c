...
static void codegen(SB *sb) {
    sb_init(&g_js_lib);
    sb_append(&g_js_lib, "// Generated by klangc 0.23 — the JavaScript half of this\n"
                         "// program's 'js fn' declarations. Pass it to emcc with\n"
                         "// --js-library; do not edit by hand.\n"
                         "mergeInto(LibraryManager.library, {\n");
    sb_append(sb, "/* Generated by klangc 0.23 — do not edit by hand */\n");
...
static const char *TEMPLATE_WEB =
    ...
    "// this project: the markup is std/ui and the styling is std/css, both built\n"
    ...
    "fn view() -> ui.Node {\n"
    "    return ui.col([\n"
    "        ui.h1(\"Hello from Klang\"),\n"
    "        ui.line(\"The page is yours. It is built in src/main.kkg.\"),\n"
    "        ui.button(\"click me\", || { clicks += 1; ui.refresh() }),\n"
    "        ui.with(ui.tag(\"span\", \"${clicks} clicks\"), [ui.id(\"count\")]),\n"
    "    ])\n"
    "}\n"
    "\n"
    ...
    "    dom.useStyle(css.sheet(styles()))\n"
    "    // `mount` renders now and again on every `refresh`, patching the DOM\n"
    "    // rather than replacing it - which is what leaves an <input> alone.\n"
    "    ui.mount(\"#app\", view)\n"
    "}\n";
...
int main(int argc, char **argv) {
    ...
    if (argc < 2 || strcmp(argv[1], "--help") == 0 || strcmp(argv[1], "-h") == 0) {
        printf("klangc - the Klang compiler (0.23)\n\n"
               "Start something:\n"
    ...
    if (strcmp(argv[1], "--version") == 0) { printf("klangc 0.23.0\n"); return 0; }
