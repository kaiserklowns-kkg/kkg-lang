...
static void codegen(SB *sb) {
    sb_init(&g_js_lib);
    sb_append(&g_js_lib, "// Generated by klangc 0.20 — the JavaScript half of this\n"
                         "// program's 'js fn' declarations. Pass it to emcc with\n"
                         "// --js-library; do not edit by hand.\n"
                         "mergeInto(LibraryManager.library, {\n");
    sb_append(sb, "/* Generated by klangc 0.20 — do not edit by hand */\n");
...
int main(int argc, char **argv) {
    ...
    if (argc < 2 || strcmp(argv[1], "--help") == 0 || strcmp(argv[1], "-h") == 0) {
        printf("klangc - the Klang compiler (0.20)\n\n"
               "Start something:\n"
    ...
    if (strcmp(argv[1], "--version") == 0) { printf("klangc 0.20.0\n"); return 0; }
