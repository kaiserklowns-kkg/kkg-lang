...
static void codegen(SB *sb) {
    sb_init(&g_js_lib);
    sb_append(&g_js_lib, "// Generated by klangc 0.21 — the JavaScript half of this\n"
                         "// program's 'js fn' declarations. Pass it to emcc with\n"
                         "// --js-library; do not edit by hand.\n"
                         "mergeInto(LibraryManager.library, {\n");
    sb_append(sb, "/* Generated by klangc 0.21 — do not edit by hand */\n");
...
static void write_default_index(const char *path, const char *title) {
    ...
    fprintf(f,
        ...
        "\n"
        "     Nothing needs to go in here: build the page in Klang with std/html and\n"
        "     mount it with `dom.mount(\"#app\", view())`. -->\n"
        "<div id=\"app\"></div>\n"
        "\n"
...
static const char *TEMPLATE_WEB =
    "// A Klang web page. The markup is built here as values - index.html holds an\n"
    "// empty <div id=\"app\"> and nothing else. There is no JavaScript in this file.\n"
    "//\n"
    "//     klangc web run\n"
    "\n"
    "import \"std/dom\"\n"
...
static const char *TEMPLATE_WEB_HTML =
    ...
    "\n"
    "<!-- Everything inside #app is built by src/main.kkg as Klang values. This file\n"
    "     is here to declare the charset, the stylesheet and the script; there is no\n"
    "     application markup in it, and there does not need to be. -->\n"
    "<div id=\"app\"></div>\n"
    "\n"
...
int main(int argc, char **argv) {
    ...
    if (argc < 2 || strcmp(argv[1], "--help") == 0 || strcmp(argv[1], "-h") == 0) {
        printf("klangc - the Klang compiler (0.21)\n\n"
               "Start something:\n"
    ...
    if (strcmp(argv[1], "--version") == 0) { printf("klangc 0.21.0\n"); return 0; }
